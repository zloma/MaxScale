...
int main(int argc, char *argv[])
{
    ...
    execute_query(Test->maxscales->conn_rwsplit[0], "CREATE USER 'user'@'localhost' IDENTIFIED BY 'pass2'");
    execute_query(Test->maxscales->conn_rwsplit[0],
    ...
    execute_query(Test->maxscales->conn_rwsplit[0], "GRANT ALL PRIVILEGES ON *.* TO 'user'@'localhost'");
    ...
    Test->set_timeout(15);
    MYSQL * conn = open_conn(Test->maxscales->rwsplit_port[0], Test->maxscales->IP[0], (char *) "user",
                             (char *) "pass1", Test->ssl);
    ...
    Test->set_timeout(15);
    conn = open_conn(Test->maxscales->rwsplit_port[0], Test->maxscales->IP[0], (char *) "user", (char *) "pass2",
                     Test->ssl);
    ...
    Test->set_timeout(15);
    conn = open_conn(Test->maxscales->rwsplit_port[0], Test->maxscales->IP[0], (char *) "user", (char *) "pass3",
                     Test->ssl);
    if (mysql_errno(conn) == 0)
    {
        Test->add_result(1, "MaxScale ignores host in authentication\n");
