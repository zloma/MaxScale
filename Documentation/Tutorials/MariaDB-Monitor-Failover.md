...
capable of performing _failover_ and _switchover_. In addition it is, in
some circumstances, capable of _rejoining_ a master that has gone down and
later reappears.
...
```
# Manual Failover
If everything is in order, the status of the servers will look something
like this:
```
...
└─────────┴─────────────────┴──────┴─────────────┴─────────────────┘
```
If the master now for whatever reason goes down, then the output will look
like this:
```
$ maxctrl list servers
┌─────────┬─────────────────┬──────┬─────────────┬────────────────┐
...
If we now check the server status we will see that one of the remaining
...
an existing slave promoted into new master.
```
$ maxctrl list servers
┌─────────┬─────────────────┬──────┬─────────────┬────────────────────────┐
│ Server  │ Address         │ Port │ Connections │ State                  │
...
Switchover is for the cases where you explicitly want to move the master
